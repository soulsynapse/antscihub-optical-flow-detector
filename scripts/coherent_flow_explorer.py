...
Run:
    .venv\\Scripts\\python.exe scripts/coherent_flow_explorer.py
    .venv\\Scripts\\python.exe scripts/coherent_flow_explorer.py --cache <key>
    .venv\\Scripts\\python.exe scripts/coherent_flow_explorer.py --cache-root ./.cache
"""
...
def main() -> int:
    ...
    try:
        ...
        window = CoherentFlowExplorer(cache, video_path)
        window.show()
        return app.exec()
    finally:
        cache.close()
